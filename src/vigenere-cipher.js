  ...
  encrypt(message, key) {
    ...
    for(let i = 0; i < this.message.length; i++) {
      ...
      if(char < 0 || char > this.lengthABC) {
        ...
        res += String.fromCharCode((char + shift) % this.lengthABC + this.startPosition);
      }
    }
  ...
  decrypt(message, key) {
    ...
    for(let i = 0; i < this.message.length; i++) {
      ...
      if(char < 0 || char > this.lengthABC) {
        ...
        res += String.fromCharCode((char - shift + this.lengthABC) % this.lengthABC + this.startPosition);
      }
    }
